                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment_option">
                        <div class="form-group">
                            <div class="checkbox">
                                <div class="custome-checkbox">
                                    ...
                                    <label class="form-check-label fs-5 fw-bold" data-bs-toggle="collapse"
                                        href="#collapsePassword" aria-controls="collapsePassword"
                                        for="createaccount">Pay Pal</label>
                                    <img class="mr-15" src="assets/imgs/theme/icons/payment-paypal.svg" width="90"
                                        height="25" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="createaccount1"
                                        data-target="#collapsePassword1">
                                    <label class="form-check-label fs-5 fw-bold" data-bs-toggle="collapse"
                                        href="#collapsePassword1" aria-controls="collapsePassword1"
                                        for="createaccount1">CashApp</label>
                                    <img class="mr-15" src="assets/imgs/theme/cashapp.png" width="90" height="25"
                                        alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="createaccount2"
                                        data-target="#collapsePassword2">
                                    <label class="form-check-label fs-5 fw-bold" data-bs-toggle="collapse"
                                        href="#collapsePassword2" aria-controls="collapsePassword2"
                                        for="createaccount2">Venmo</label>
                                    <img class="mr-15" src="assets/imgs/theme/venmo-logo.webp" width="90" height="25"
                                        alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="#"
                        class="btn btn-fill-out btn-block mt-30 d-flex align-items-center justify-content-center">
                        <img class="me-2" src="{{ asset('assets/imgs/theme/icons/wa.png') }}" alt="WhatsApp Icon"
                ...
                if (this.checked) {
                    checkboxes.forEach(otherCheckbox => {
                        if (otherCheckbox !== this) {
                            ...
                            document.querySelector(otherCheckbox.getAttribute(
