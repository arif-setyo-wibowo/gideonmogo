...
<html>
<head>
    <title>Order Confirmation - GideonMogo</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>GideonMogo - Order Confirmation</h1>
        </div>
        ...
        <div class="footer" style="text-align: center; margin-top: 20px; font-size: 12px; color: #777;">
            <p>© {{ date('Y') }} GideonMogo. All rights reserved.</p>
            <p>Need help? Contact us at support@gideonmogo.com</p>
        </div>
    </div>
</body>
</html>
