...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">GideonMogo /</span> User Admin</h4>
    <div class="card mb-4">
                ...
                <form action="{{ route('admin.update',$admin->id)}}" method="POST">
                    ...
                    @method('put')
                      <div class="form-floating form-floating-outline mb-4">
                        <input type="hidden" class="form-control" id="basic-default-fullname" name="id" placeholder="Nama" required value="{{ $admin->id}}"/>
                          <input type="text" class="form-control" id="basic-default-fullname" name="nama" placeholder="Nama" required value="{{ $admin->nama}}"/>
