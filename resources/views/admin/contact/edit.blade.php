...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">GideonMogo /</span> Edit Kontak</h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('contact-admin.update', $contact->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="link_discord" class="form-label">Link Discord</label>
                            <input type="text" class="form-control" id="link_discord" name="link_discord" value="{{ old('link_discord', $contact->link_discord) }}" required>
                        </div>
                        ...
                        <a href="{{ route('contact-admin.index') }}" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
